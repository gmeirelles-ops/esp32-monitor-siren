# firestore-operators-catalog Specification

## Purpose
Sincronização da coleção Firestore `operators` com o cadastro local de operadores (PIN, nome, ativo), espelhando o padrão do catálogo de produtos.
