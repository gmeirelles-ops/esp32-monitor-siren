...
O app SHALL oferecer reconciliação que, para um `(id_produto, ano)`, identifique buracos (sequenciais ausentes) e duplicatas na sequência de seriais aprovados.
...
- **WHEN** o mesmo sequencial aparece mais de uma vez entre os aprovados
- **THEN** o app lista o(s) sequencial(is) duplicado(s)
