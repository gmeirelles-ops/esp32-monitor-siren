# posto-bancada-setup Specification

## Purpose
Vínculo único de bancada por instalação do posto, gate de setup após login e alteração de bancada somente em Configurações.
