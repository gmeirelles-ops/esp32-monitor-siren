# hardware-monitoring Specification

## Purpose
Monitoramento e recuperação de falhas de hardware crítico (PZEM-004T) no firmware ESP32, com alertas MQTT de falha e recuperação.
## Requirements
