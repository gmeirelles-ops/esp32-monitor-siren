...
O app SHALL oferecer navegação entre as seções: Dispositivos, Lote, Etiquetas, Configurações e Admin.

#### Scenario: Acesso às seções
- **WHEN** o operador abre o app
- **THEN** uma barra de navegação permite alternar entre Dispositivos, Lote, Etiquetas, Configurações e Admin
