...
**Reason**: O posto exige identificação explícita em cada abertura do app para rastreabilidade de turno.
**Migration**: Remover leitura de `active_operator_id` no startup; manter campo apenas em memória durante a execução ou limpar ao iniciar.
