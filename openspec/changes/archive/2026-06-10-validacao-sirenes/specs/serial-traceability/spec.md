...
O cálculo do dígito verificador ITF 2 de 5 e a montagem do serial completo SHALL ser realizados pelo App Web a partir do sequencial aprovado.

#### Scenario: Geração do serial após aprovação
- **WHEN** o App Web recebe a confirmação de aprovação com o sequencial consumido
- **THEN** o App Web calcula o dígito verificador e gera o número de série completo de 10 dígitos
